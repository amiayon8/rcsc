  ...
  return (
    <>
      ...
      <section id="about" className="p-0!">
        ...
        <div className="mx-auto px-5 py-20 max-w-300 container">
          <div className="mb-15 text-center">
            <h2 className="text-shadow-sm font-black text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl uppercase">
              Departments</h2>
      ...
      <div className="relative">
        <GradientDots />
        <section id="achievements" className="bg-transparent! py-20">
        ...
        <section id="resources" className="bg-transparent! py-20">
          <div className="mx-auto px-5 max-w-300 container">
            <div className="mb-15 text-center">
              <h2 className="font-black text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl uppercase">
                Our Activities</h2>
        ...
        <section id="panel" className="bg-transparent! py-20">
          <div className="mx-auto px-5 max-w-300 container">
            <div className="mb-15 text-center">
              <h2 className="font-black text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl uppercase">
                Our
