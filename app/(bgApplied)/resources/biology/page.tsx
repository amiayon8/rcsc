...
const biologyResourcesData = [
    {
        title: "biology Olympiad Guidelines",
        description: "Comprehensive strategies, syllabus breakdowns, and recommended problem-solving materials to prepare for competitive biology olympiads.",
        category: "Preparation Guide",
        readTime: "10 min read",
        icon: Target,
        href: "/resources/biology/biology-olympiad-guidelines"
    }
    // You can add more biology content here later!
];

export default function biologyResources() {
    return (
        <main className="relative mx-auto px-6 pt-32 pb-24 max-w-7xl overflow-hidden">
            ...
            <div className="gap-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {biologyResourcesData.map((item, index) => {
